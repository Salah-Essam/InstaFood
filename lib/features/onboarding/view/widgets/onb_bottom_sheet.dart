...
class OnbBottomSheet extends StatelessWidget {
  ...
  String _icon(int i) =>
      i == 0 ? 'assets/svgs/Transfer Document icon.svg' : i == 1 ? 'assets/svgs/Card icon.svg' : 'assets/svgs/Deliver Boy Icon.svg';

  String _title(int i) => i == 0 ? AppStrings.onb1Title : i == 1 ? AppStrings.onb2Title : AppStrings.onb3Title;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: AppColors.sheetShadow, blurRadius: 12, offset: const Offset(0, -4))],
        ...
        builder: (context, state) {
          return Column(
            ...
            children: [
              ...
              Text(_title(state.index), style: AppTextStyles.title, textAlign: TextAlign.center),
              SizedBox(height: 12.h),
              Text(AppStrings.onbBody, style: AppTextStyles.body, textAlign: TextAlign.center),
