...
class SetPasswordPageState extends State<SetPasswordPage> {
  ...
  ConfirmPasswordAppValidator confirmPasswordValidator =
                          ...
                          Center(
                            child: AppButton(
                              ...
                              onPressed: () {
                                ...
                                confirmPasswordValidator.setValue(
                                  confirmPasswordController.text,
                                );
                                confirmPasswordValidator.comparedWithPassword =
                                    passwordController.text;
                                final passErrors = passwordValidator.check();
                                final confirmErrors = confirmPasswordValidator
                                    .check();
                                if (passwordController.text.isNotEmpty &&
                                    confirmPasswordController.text.isNotEmpty &&
                                    passErrors.isEmpty &&
                                    confirmErrors.isEmpty) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text('Password fields valid'),
                                      backgroundColor: AppColors.success,
                                    ),
                                  );
                                }
